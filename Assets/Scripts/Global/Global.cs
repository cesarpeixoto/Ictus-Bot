...
public struct NetworkSelectorHitState
{
    ...
    public override bool Equals(object Obj)
    {
        NetworkSelectorHitState other = (NetworkSelectorHitState)Obj;
        if (!CompareArrays(this.opponent, other.opponent)) return false;
        if (!CompareArrays(this.allies, other.allies)) return false;
    ...
    public static bool operator ==(NetworkSelectorHitState that, NetworkSelectorHitState other)
    {
        return that.Equals(other);
    }
    ...
    private static bool CompareArrays(NetworkDinamicEnity[] that, NetworkDinamicEnity[] other)
    {
        if (that == null && other == null)
            return true;
        if (that != null && other == null)
